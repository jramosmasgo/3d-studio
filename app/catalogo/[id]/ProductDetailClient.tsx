...
export default function ProductDetailClient({ id }: { id: string }) {
  ...
  const handleBuyOnWhatsapp = () => {
    ...
    const { discountedPrice } = getDiscountedPrice(product, activeOffer);

    const text = `Hola, deseo consultar sobre el producto:
*${product.name}*
• *Precio:* S/. ${discountedPrice.toFixed(2)}
• *Material:* ${product.material || "Resina"}
...
Enlace al producto: ${currentUrl}`;
  ...
  useEffect(() => {
    ...
    // Actualizar metadatos Open Graph en el cliente para SPA
            ...
            <div className="flex flex-col gap-4 mt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="bg-surface-container-low hover:bg-surface-container-high transition-all duration-300 p-4 rounded-md border border-outline-variant/10 flex flex-col items-center text-center gap-2 relative group hover:-translate-y-0.5">
                  ...
                  <svg className="w-8 h-8 text-primary mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 002.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72M6.75 18h.008v.008H6.75V18Zm0-3h.008v.008H6.75V15Zm0-3h.008v.008H6.75V12Zm9 6h.008v.008H15.75V18Zm0-3h.008v.008H15.75V15Zm0-3h.008v.008H15.75V12Z" />
                  </svg>
                  <span className="text-[0.75rem] font-bold text-primary font-headline">
                    Compra en Tienda
                  </span>
